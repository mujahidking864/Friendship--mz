...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923030823055-1632403322@g.us',
    ...
    NOT_ALLOWED: process.env.ALLOWED || '95,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Friendship",
    BOT_NAME: process.env.BOT_NAME || 'Friendship',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "public" ? 'Mujahid¹¹ꫂ;Raganork MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
